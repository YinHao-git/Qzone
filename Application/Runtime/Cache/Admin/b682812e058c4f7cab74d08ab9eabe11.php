...
<html lang="en">
	...
	<table class="table table-striped table-bordered table-responsive table-hover table-responsive container-fluid">
		<tr>
			<th>Id</th>
			<th>Photo</th>
			<th>Name</th>
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			<td><?php echo ($v['id']); ?></td>
			<td><img style="height:60px" src="/qzone16/Public/Uploads/<?php echo ($v['photo']); ?>"></td>
			<td><?php echo ($v['name']); ?></td>
			<td>  
				   <?php if($v["sex"] == '0'): ?>女
                    <?php elseif($v["sex"] == '1'): ?>男<?php endif; ?>
            </td>
			<td><?php echo ($v['age']); ?></td>
			<td><?php echo ($v['address']); ?></td>
			<td>
				   <?php if($v["status"] == '0'): ?>超级管理员
	                <?php elseif($v["status"] == '1'): ?>普通管理员<?php endif; ?>
             </td>
			<td><?php echo ($v['phone']); ?></td>
			<td><?php echo Date('Y-m-d H:i:s',$v['addtime']);?></td>
			<td>
				<a href="<?php echo U('Admin/add');?>"><button type='button' class='btn btn-success'>添加用户</button></a>
				<a href="<?php echo U('edit',array('id'=>$v['id']));?>"><button type='button' class='btn btn-primary'>编辑用户</button></a>
				<a href="<?php echo U('del',array('id'=>$v['id']));?>"><button type='button' class='btn btn-danger'>删除用户</button></a>
			</td>
		</tr><?php endforeach; endif; ?>
		<tr>
			<td>
			<button class="btn"><?php echo ($page); ?></button>
			</td>
		</tr>
	</table>
	</center>
