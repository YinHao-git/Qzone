...
<html lang="en">
	...
	<table class="table table-striped table-bordered table-responsive table-hover table-responsive container-fluid">
		...
		<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
				...
				<td>
					<a href="<?php echo U('Notice/add');?>"><button type='button' class='btn btn-success'>发表公告</button></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<?php echo U('Notice/del',array('id'=>$v['id']));?>"><button type='button' class='btn btn-danger'>删除公告</button></a>
				</td>
