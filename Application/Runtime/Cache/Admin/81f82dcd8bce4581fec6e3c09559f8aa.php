...
<html lang="en">
	...
	<div class="col-md-3 h4">
		<table class="table table-hover">
			<tr>
				<th>uid:</th><td><?php echo ($data["uid"]); ?></td>
			</tr>
			<tr>
				<th>真实姓名:</th><td><?php echo ($data["name"]); ?></td>
			</tr>
			<tr>
				<th>年龄:</th><td><?php echo ($data["age"]); ?></td>
			</tr>
			<tr>
				<th>生日:</th><td><?php echo ($data["birth"]); ?></td>
			</tr>
			<tr>
				<th>民族:</th><td><?php echo ($data["race"]); ?></td>
			</tr>
			<tr>
				<th>地址:</th><td><?php echo ($data["address"]); ?></td>
			</tr>
			<tr>
				<th>修改时间:</th><td><?php echo ($data["addtime"]); ?></td>
			</tr>
		</table>
