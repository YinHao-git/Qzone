...
<html lang="en">
	...
	<form action="<?php echo U('Userh/update');?>" method="post">
	<div class="col-md-3">
		<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
		<input type="radio" name="status" value="0" <?php if($data["status"] == '0'): ?>checked<?php endif; ?>>该用户不良 应被禁用<br>
		<input type="radio" name="status" value="1" <?php if($data["status"] == '1'): ?>checked<?php endif; ?>>普通用户<br>
		<input type="radio" name="status" value="2" <?php if($data["status"] == '2'): ?>checked<?php endif; ?>>会员<br>
