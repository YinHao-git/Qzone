...
<html lang="en">
	...
	<center><h1>网站友情链接管理</h1>
	<table class="table table-striped table-bordered table-responsive table-hover table-responsive container-fluid">
		<tr>
				<th class="col-md-3">Id</th>
				<th class="col-md-3">LinkName</th>
				<th class="col-md-3">LinkAddress</th>
				<th class="col-md-3">Action</th>
		</tr>
		<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
				<td><?php echo ($v["id"]); ?></td>
				<td><?php echo ($v["linkname"]); ?></td>
				<td><?php echo ($v["linkaddress"]); ?></td>
				<td>
					<a href="<?php echo U('Link/add');?>"><button type='button' class='btn btn-success'>添加链接</button></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<?php echo U('Link/del',array('id'=>$v['id']));?>"><button type='button' class='btn btn-danger'>删除链接</button></a>
				</td>
