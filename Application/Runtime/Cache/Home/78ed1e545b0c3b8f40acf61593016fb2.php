...
<div class="banner">
  <div class="header">
    <div class="hea">
      ...
      <div class="But">
        <img src="/qzone16/Public/home/images/bba_thumb.gif" class='bq'/>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class='msgBox'>
      <dl><dt><img src='/qzone16/Public/uploads/<?php echo ($v["photo"]); ?>' width='50' height='50'/></dt><dd><?php echo ($v["username"]); ?></dd><dd class="del btn" style="text-align: right;width:50px;height:20px"><input class="put" type="hidden" value="<?php echo ($v["id"]); ?>">删除</dd></dl>
        <div class='msgTxt'>
          <?php echo ($v["content"]); ?>
    ...
    <script src="/qzone16/Public/home/js/jquery.nicescroll.js"></script>
      ...
      $("span").click(function(){
        ...
        $.ajax({
          ...
          success:function(datas){
            $(".msgCon").prepend("<div class='msgBox'><dl><dt><img src='/qzone16/Public/uploads/"+datas[0].photo+"' width='50' height='50'/></dt><dd>"+datas[0].username+"</dd></dl><div class='msgTxt'>"+txt+"<dd style='text-align: right'>刚刚</dd></div></div>");
            }
        })
