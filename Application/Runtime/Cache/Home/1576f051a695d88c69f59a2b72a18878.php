  ...
  <div class="container_12">
    <article class="grid_12">
      ...
      <hr>
          ...
          <br>
          <div class="But">
            <img src="/qzone15/Public/home/images/bba_thumb.gif" class='smallpic'/>&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div id="content" style="width:1000px;height:450px;">
          ...
          <div class="talkcom">
              <div class='talkBox'>
                  <dl>
                      <dt>
                          <img src='/qzone15/Public/uploads/<?php echo ($v["photo"]); ?>' width='50' height='50'/>
                      </dt>
 ...
 $(".btn").click(function(){
        ...
        $.ajax({
            ...
            success:function(datas){
                $(".talkcon").prepend("<div class='talkBox'><dl><dt><img src='/qzone15/Public/uploads/"+datas[0].photo+"' width='50' height='50'/></dt><dd>"+datas[0].username+"</dd></dl><div class='talkTxt'>"+txt+"<dd style='text-align:right'>刚刚</dd></div></div>");
            }
        })
        //清空写入框
        $('.message').html(null);
